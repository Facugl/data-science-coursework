...
\begin{itemize}[leftmargin=2cm]
    ...
    \item \textbf{Maximal / Minimal:} El grafo \textbf{no es maximal} ni \textbf{minimal}.
    No es maximal porque no contiene todas las aristas posibles entre sus vértices.
    No es minimal porque contiene ciclos —por ejemplo $1 \to 2 \to 1$—,
    por lo que podrían eliminarse aristas y el grafo seguiría siendo conexo.
\end{itemize}
